...
def result():
    model = load_model('d:/workspace/Python2/models/rides.h5')
    scaler = joblib.load('d:/workspace/Python2/models/rides_scaler.sav')
    ...
    return render_template('rides/result.html',
                           ...
                           weekend=weekend, child=child, distance=distance, rides=rides,
                           games=games, wait=wait, clean=clean)
